...
import {
  Pencil, Trash, Gavel, BookOpen, Upload,
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-all flex-shrink-0">
                      ...
                      <button className="p-1.5 bg-red-50 text-red-600 rounded-lg hover:bg-red-100"><Trash size={12} /></button>
                    </div>
                  </div>
              ...
              <div key={m.id} className={`group relative pl-4 border-l-2 ${m.is_primary ? 'border-emerald-400' : 'border-[#C5A059]/50'} py-1`}>
                <div className="flex justify-between items-start gap-2">
                  ...
                  <div className="flex gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
                    ...
                    <button className="text-slate-500 hover:text-red-400 transition-colors"><Trash size={12} /></button>
                  </div>
                </div>
              </div>
            ))}
              ...
              <button className="w-full flex items-center justify-between px-6 py-4 hover:bg-slate-50 transition-colors text-left gap-4" onClick={() => setExpandedFaq(expandedFaq === idx ? null : idx)}>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <button onClick={(e) => e.stopPropagation()} className="p-1 text-red-500 hover:bg-red-50 rounded"><Trash size={13} /></button>
                  </div>
