...
import { useAppDispatch, useAppSelector } from "../../redux/hooks"; // Assuming you have typed hooks
...
// Utility to handle status-based icons since we removed specific event types
...
const JudgeEvents = () => {
  ...
  // Find the next immediate session for the highlight card
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold font-serif text-[#1a3a2a]">2026 HIGH COURT JUDGES EVENTS</h1>
        </div>
            ...
            <div className="relative z-10">
              ...
              {nextSession ? (
                <>
                  ...
                  <p className="text-xs mt-4 font-black uppercase tracking-widest text-[#C9922A]">
                    ...
                    <div className="p-6">
                      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                        <div className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${statusStyle.bg} ${statusStyle.color}`}>
                          <Clock size={12} />
                          {currentFilter === "ALL" ? "Event" : currentFilter}
                        </div>
