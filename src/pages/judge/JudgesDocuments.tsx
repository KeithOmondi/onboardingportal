...
import { Search, FileText, Trash2, Eye, Calendar, FileSearch,  } from "lucide-react";
...
const JudgesDocuments = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto bg-[#f9faf9] min-h-screen font-sans">
      ...
      {/* The Modal now handles the fetching and cleanup internally 
          using the streamFile thunk and revokeBlobUrl reducer.
      */}
      {selectedDocument && (
        <PreviewModal 
