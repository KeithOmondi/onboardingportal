...
const LoginPage = () => {
 ...
 useEffect(() => {
  ...
  // Check mustResetPassword independently of isAuthenticated
...
<div className="hidden lg:flex lg:w-1/2 bg-[#1a3a2a] relative items-center justify-center p-12 overflow-hidden border-r border-[#C9922A]/20">
  ...
  {/* Refined Background Elements - Using Gold and Deep Green Blurs */}
  ...
  <div className="relative z-10 flex flex-col items-center text-center max-w-lg">
    {/* Logo Container - Controlled Size */}
    ...
    {/* Typography with Gold/White balance */}
...
<div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white">
  <div className="w-full max-w-md">
    {/* Header Section */}
    <div className="text-center lg:text-left text-center mb-10">
      <h2 className="text-3xl font-serif text-center font-bold text-slate-900 tracking-tight">
        Judges <span className="text-[#1a3a2a]">Login</span>
      </h2>
      <p className="mt-3 text-slate-500 text-center capitalize font-medium">
